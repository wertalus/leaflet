...
<div class="w3-container">
    <header>
        ...
        <div class="w3-container" style="vertical-align:middle; display: inline"> 
            <span style="font-size: 24px;">Wyszukaj punkt zainteresowania :</span>
            <input style="width: 300px; height: 40px;" id="city" type="text" class="w3-round w3-margin-left w3-border w3-hover-shadow w3-hover-shadow" placeholder="Podaj miasto"></input>
            <input style="width: 300px; height: 40px;" id="radius" type="text" class="w3-round w3-margin-left w3-border w3-hover-shadow w3-hover-shadow" placeholder="Podaj obszar do przeszukania w km"></input>
            <button type="submit" style="background-color: transparent;width: 300px; height: 40px;" id="search1" class="w3-round w3-margin-left w3-border w3-hover-shadow w3-hover-shadow">Wyszukaj Banki</button>
        </div>



    <div style="height:80px" id="foundbanks" class="w3-cell-row"><p style="text-align:left; font-size:20px"> Lista banków :</p></div>
    <div id="map"></div>
