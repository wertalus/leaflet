...
<article>
    <div class="w3-container w3-border w3-margin-top">
        <div style="margin-top: 250px;" class="col-sm-10 w3-border w3-round-large w3-display-middle">
                ...
                <div id="bank" type="button" style="text-align: center;" class="w3-hover-shadow w3-margin-top w3-margin-bottom w3-border w3-round-large nav-link">
                    Wyszukaj Bank
                </div>
                    
                <div id="route" type="button" style="text-align: center;" class="w3-hover-shadow w3-margin-top w3-margin-bottom w3-border w3-round-large nav-link">
                    Wyszukaj trasę
                </div>			
        </div>
